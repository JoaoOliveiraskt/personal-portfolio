  ...
  return (
    ...
    >
      ...
      <div className="flex flex-col max-w-[60rem] gap-12 sm:gap-10">
        <div className="flex flex-col items-center justify-center gap-6 sm:gap-3 z-10">
          <Balancer>
            <p className="tracking-tighter max-w-[40rem] text-center text-4xl sm:text-3xl font-bold pb-2 bg-gradient-to-r from-primary via-primary to-text text-transparent bg-clip-text">
