...
const HeroContent = () => {
  ...
  return (
    <motion.div
      initial="hidden"
      animate="visible"
      className="flex flex-col justify-center items-center w-full h-full z-50"
    >
      <div className="h-full w-full flex flex-col justify-center items-center gap-7 sm:gap-6 text-center ssm:mt-10 pb-16 med:pb-0">
        ...
        <motion.div
          ...
          className="tracking-tighter text-7xl ssm:text-3xl sm:text-5xl font-medium text-primary max-w-[900px] h-auto"
        >
          <h1>
            <Balancer>
              I want to{" "}
        ...
        <motion.p
          ...
          className="tracking-wide text-lg text-text  max-w-[700px] sm:text-sm"
        >
        ...
        <motion.div
          ...
          className="flex flex-row justify-between items-center rounded-2xl  gap-5 py-[8px] px-[10px]"
        >
          ...
          <motion.button
            variants={slideInFromLeft(0)}
            className="cursor-pointer hover:bg-accent py-2  border text-center rounded-xl w-[200px] sm:w-40 transition-colors duration-300"
          >
            <a
              target="_blank"
