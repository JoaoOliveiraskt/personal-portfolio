...
export default function PresentationText({ className }: Props) {
  return (
    <h3 className={`tracking-wide leading-loose text-text font-medium max-w-[810px] ${className}`}>
      <Balancer>
        Olá, eu sou João, um desenvolvedor front-end localizado em Saquarema, Rio de Janeiro, com {getMonthDifference()} meses de experiência em desenvolvimento web.
        Graduando em Engenharia de Software na{" "}
